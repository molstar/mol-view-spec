...
export const CustomLabel = PluginBehavior.create<{ autoAttach: boolean, showTooltip: boolean }>({
    name: 'custom-label',
    ...
    ctor: class extends PluginBehavior.Handler<{ autoAttach: boolean, showTooltip: boolean }> {
        private provider = CustomLabelRepresentationProvider;
        ...
        register(): void {
            this.ctx.representation.structure.registry.add(this.provider);
        ...
        unregister() {
            this.ctx.representation.structure.registry.remove(this.provider);
