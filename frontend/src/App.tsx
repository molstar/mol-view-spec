...
function Main() {
    ...
    const exampleUrls = {
        ...
        'colors_from_source': 'http://localhost:9000/api/v1/examples/testing/color_from_source',
        ...
        'labels_from_uri': 'http://localhost:9000/api/v1/examples/testing/labels_from_uri',
        'labels_from_uri grouped': 'http://localhost:9000/api/v1/examples/testing/labels_from_uri?annotation_name=domains-grouped',
        'labels_from_uri 3j3q': 'http://localhost:9000/api/v1/examples/testing/color_validation?id=3j3q&tooltips=true&labels=true',
        'labels_from_source': 'http://localhost:9000/api/v1/examples/testing/labels_from_source',
