...
// deno-lint-ignore-file ban-types no-namespace
...
export function Argument<T extends Type>(
  type: T,
  params?: { description?: string; defaultValue?: T["@type"]; isOptional?: boolean; isRest?: boolean },
): Argument<T> {
...
export namespace Arguments {
  ...
  export function List<T extends Type>(
    type: T,
    params?: { nonEmpty?: boolean },
  ): Arguments<{ [key: string]: T["@type"] }> {
