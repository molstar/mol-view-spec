...
export const keywords: KeywordDict = {
  ...
  polymer: {
    "@desc":
      "All atoms on the polymer (not het). Finds atoms with residue identifiers matching a known polymer, such a peptide and DNA.",
    abbr: ["pol."],
    map: () =>
      B.struct.generator.atomGroups({
        "residue-test": B.core.set.has([
  ...
  organic: {
    "@desc":
      "All atoms in non-polymer organic compounds (e.g. ligands, buffers). Finds carbon-containing molecules that do not match known polymers.",
    abbr: ["org."],
    map: () =>
      h.asAtoms(B.struct.modifier.expandProperty({
  ...
  inorganic: {
    "@desc":
      "All non-polymer inorganic atoms/ions. Finds atoms in molecules that do not contain carbon and do not match any known solvent residues.",
    abbr: ["ino."],
    map: () =>
      h.asAtoms(B.struct.modifier.expandProperty({
        "0": B.struct.modifier.union([
