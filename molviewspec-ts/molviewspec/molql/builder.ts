...
import { MolScriptSymbolTable as SymbolTable } from "./language/symbol-table.ts";
...
export namespace MolScriptBuilder {
  ...
  export function atomName(s: string) {
    return struct.type.atomName([s]);
  }
  /** Element-symbol constructor */
  export function es(s: string) {
    return struct.type.elementSymbol([s]);
  }
  /** List constructor */
  export function list(...xs: Expression[]) {
    return core.type.list(xs);
  }
  /** Set constructor */
  export function set(...xs: Expression[]) {
  ...
  export function evaluate(x: Expression) {
  ...
  /** atom core property */
  export function acp(p: keyof typeof _acp) {
    return (_acp[p] as MSymbol<any>)();
  }

  /** atom topology property */
  export function atp(p: keyof typeof _atp) {
  ...
  export function acpSet(p: keyof typeof _acp) {
    return _aps([acp(p)]);
  }
  /** atom topology property set */
  export function atpSet(p: keyof typeof _atp) {
    return _aps([atp(p)]);
  }
