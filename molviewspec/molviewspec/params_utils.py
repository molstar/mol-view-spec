...
from typing import Type, TypeVar, Iterable, ForwardRef
...
def _required_keys(params_type: Type[Params]) -> Iterable[str]:
    ...
    if any(isinstance(annot, ForwardRef) for annot in params_type.__annotations__.values()):
        ...
        raise ValueError(f"Cannot use this function with typed dict {params_type.__name__} because it was defined with `from __future__ import annotations`, see Python bug https://github.com/python/cpython/issues/97727")
    else:
